...
contract BidData{
    ...
    function getDataDetails(address addr, uint index) view public returns (bytes32,address,bytes32,bytes32,uint,uint,address){
        Data memory d = data[dataOwned[addr][index]];
        return (d.id, d.sensor, d.dataHash, d.location, d.bid, d.timestamp, d.farmManager);
    }
}
